        ...
        <div className="container-max">
          ...
          <div className="max-w-3xl">
            ...
            <section className="mb-10">
              ...
              <p className="text-base font-light text-[#1A1A1A]/70 leading-relaxed mb-4">
                <strong className="text-[#1A1A1A]">Бисквитки за производителност</strong> — биха ни помогнали
                да разберем как посетителите взаимодействат с нашия уебсайт. Понастоящем сайтът не зарежда
                аналитични бисквитки от трети страни; ако в бъдеще добавим такива, те ще се активират
                единствено след вашето изрично съгласие.
              </p>
              <p className="text-base font-light text-[#1A1A1A]/70 leading-relaxed">
                <strong className="text-[#1A1A1A]">Бисквитки за функционалност</strong> — биха запомняли
                вашите предпочитания (като език или регион). Активираме ги само след вашето съгласие.
              </p>
            </section>
