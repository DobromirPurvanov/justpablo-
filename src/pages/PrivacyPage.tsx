        ...
        <div className="container-max">
          ...
          <div className="max-w-3xl">
            ...
            <section className="mb-10">
              ...
              <p className="text-base font-light text-[#1A1A1A]/70 leading-relaxed">
                <strong className="text-[#1A1A1A]">Автоматично събирана информация:</strong>
              </p>
              <ul className="list-disc list-inside space-y-2 text-base font-light text-[#1A1A1A]/70 leading-relaxed">
                ...
                <li>Страници, които посещавате на нашия сайт</li>
                <li>Време и продължителност на посещението</li>
              </ul>
            </section>
